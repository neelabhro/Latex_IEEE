...
\begin{abstract}
无线传感器网络，预计在不久的将来找到广泛的适用性和得到越来越多的部署。在本文中，我们提出了一个正式的分类的传感器网络，基于其运作模式，分为主动式网络与反应式网络。反应式网络，相对于被动收集数据的主动网络，可以对快速变化的相关参数进行响应。我们针对反应式网络引入了一个新的节能协议，TEEN(阈值敏感的高效无线传感网协议)。我们用于一个简单的温度传感应用评估我们协议的性能。在能源效率方面，我们已经观察到此协议优于现有的传统传感器网络协议。
\end{abstract}
